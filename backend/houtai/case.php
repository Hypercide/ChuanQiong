...
<head>
	...
	<title>工程案例后台</title>
	<style type="text/css">
	form{width: 800px;height: 300px;margin:0 auto; border: 1px solid #ccc;text-align: center;}
	li{list-style: none;padding: 5px 15px;}
	</style>
</head>
<body>

	<form method="post" action="case_save.php" enctype="multipart/form-data">
