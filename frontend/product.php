...
<div id="top">
 ...
 <div id="mains">
		<div class="left">
			 <div class="list">
				  <div class="product"><li>产品中心</li><span>PRODUCTS</span></div>
				  <div class="ser">
				  <?php
				  		$sql="select * from classes where type=3";
				  		$query=$db->query($sql);
		...
		<div class="right">
			 ...
			 <div class="pic">
			 	<?php
			 		...
			 		$str="";
			 		if($id){
				 		$sql="select  count(id) as c from product where class_id=$id";			 	
				 		$search .= "&id=$id";
			 		}
			 		else
			 		{
				 		...
				 		if($id){
				 			$sql="select * from product where class_id=$id limit $start_pos , $pageper";
				 		}else{
				 			$sql="select * from product limit $start_pos , $pageper";
				 		}
				 		$query  =$db->query($sql);
				 		$result =$query->fetchall();
				 		$str    ="";
			 		...
			 		foreach ($result as $row) {
 						...
 						$str .="<a href='./product_detail.php?id=$id'>"."<br/>"."<img src='$img'>"."</a>";
 						$str .="<a href='./product_detail.php'>"."<br/>".$row['name']."</a>";
			 			$str .="</li>";
			 		}
			 		echo $str;
